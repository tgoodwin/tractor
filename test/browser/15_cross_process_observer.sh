...
token="$(tractor_reap_serve "examples/haiku_feedback.dot")"
...
ab_wait_event fn "document.querySelector('g.tractor-node[data-node-id=\"ask_claude\"]')?.classList.contains('succeeded')"
ab_wait_event fn "document.querySelector('g.tractor-node[data-node-id=\"ask_codex\"]')?.classList.contains('succeeded')"
ab_wait_event fn "document.querySelector('g.tractor-node[data-node-id=\"summarize\"]')?.classList.contains('succeeded')"
